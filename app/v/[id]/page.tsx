...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://ngewecewektobrut.pages.dev/v/${file.filecode}`,
